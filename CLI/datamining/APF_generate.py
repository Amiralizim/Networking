...
df1 = pd.read_csv("/var/lib/mysql-files/21-Network-Traffic/Dataset-Unicauca-Version2-87Atts.csv", names = ds1_column_names)
...
df2 = pd.read_csv("/var/lib/mysql-files/21-Network-Traffic/Unicauca-dataset-April-June-2019-Network-flows.csv", names = ds2_column_names)
...
with open('/var/lib/mysql-files/CLI/datamining/APF.csv', mode='w') as csv_file:
